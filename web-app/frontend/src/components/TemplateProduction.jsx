...
export default function TemplateProduction({ currentUser }) {
  ...
  const subtitleReplacementIssues = subtitleEnabled && selectedTemplate?.runtime_capabilities?.subtitle_replacements
    ? subtitleReplacementStatus.issues
    : [];
  const hasUnsavedSubtitleReplacements = Boolean(
    subtitleEnabled && selectedTemplate?.runtime_capabilities?.subtitle_replacements
  ...
  const submitTask = useCallback(async () => {
    ...
    try {
      ...
      form.append("video_config", JSON.stringify({ subtitle_style: subtitleStyle, subtitle_enabled: subtitleEnabled }));
